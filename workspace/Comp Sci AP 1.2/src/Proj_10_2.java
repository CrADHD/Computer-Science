...
class SavingAccount1 implements account1{
	 ...
	 * @param newBalance
	 */
	public SavingAccount1(double newBalance, double NewNum, double NewFee, String NewName)
	{
		Username = NewName;
		AccountNum = NewNum;
		Fee = NewFee;
...
class CheckingAccount implements account1{
	public double Balance;
...
class CashDeposit implements account1{
	public double Balance;
	public double Interest;
	public double AccountNum;
	 ...
	 * @return 
	 */
	public void SavingAccount(double newBalance, double NewNum, double NewInterest, double ExpDate, String NewName)
	{
		Username = NewName;
		AccountNum = NewNum;
		Interest = NewInterest;
