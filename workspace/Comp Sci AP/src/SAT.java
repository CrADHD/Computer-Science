...
public class SAT {
	...
	public static int Q1(int WC){
		...
		System.out.println("Ms. FergussonÕs main criticism of the artistÕs ");
		System.out.println("rendering of the ancient mammalÕs physical ");
	...
	public static int Q12(int WC){				// Question 12
		...
		System.out.println("Q12: |6 Ð 16y| =2");
		System.out.println("|14 Ð 8y|=10");
